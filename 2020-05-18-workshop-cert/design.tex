...
\begin{frame}
  ...
  Filling Blanks is a (technical) extension of Freetext. It is more specific and the \emph{blank screen of horror} problem, whilst testing vocabulary. An example:
