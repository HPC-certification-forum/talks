...
\begin{frame}{Certification: Assessment Prototype}
		\begin{itemize}
			\item[\color{goettingenBlue}{1.}] User takes multiple-choice test online (any time!)
			\begin{itemize}
			...
			\end{itemize}
			\item[\color{goettingenBlue}{2.}] Choices are submitted to the web server
			\item[\color{goettingenBlue}{3.}] \textit{Approval} of the result
			\item[\color{goettingenBlue}{4.}] Automatic creation of certificate and returned by email
			\begin{itemize}
