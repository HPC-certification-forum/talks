...
\item Developed examination prototype with first (but limited exam) 
\item Adoption 
\end{itemize}
\end{block}
...
\begin{itemize}
  ...
  \item More "expert adopted skills"
...
\begin{itemize}
  \item At the moment - all our activities on voluntary basis - this is slow
    \begin{itemize}
      \item because we believe in it
    \end{itemize}
  \item Need funding of at least 1 advisor for creating and curating skills (essential)
    \begin{itemize}
      \item Would also organize workshops to train the trainers and videos in YouTube
    \end{itemize}
  \item A technician to support development of the ecosystem (desirable)
    \begin{itemize}
      \item from prototype to production
    \end{itemize}  
  \item Official endorsment by data centers and programmes (e.g. EuropeHPC JU)
  \item Collaboration and contribution by programmes to skills (e.g. EuropeHPC JU)
  \item Support in organizing BoFs and workshops (desirable)
  \item Need to expand our server infrastructure to another home (doable)
\end{itemize}
\end{frame}
